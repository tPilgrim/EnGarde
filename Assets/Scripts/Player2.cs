...
public class Player2 : MonoBehaviour
{
    ...
    void Dash()
    {
        ...
        if (Input.GetKey(KeyCode.DownArrow) && IsGrounded && !IsDashing && CanDash && CanDashAgain && !IsAttacking)
        {
    ...
    void Attack()
    {
        if (Input.GetKey(KeyCode.Return) && !IsAttacking && !IsDashing && NextAttack && IsGrounded && CanAttack)
        {
